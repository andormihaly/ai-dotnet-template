...
description: >
  ...
  authorization, secrets, input validation, configuration, dependency risks,
  data exposure, and common web vulnerabilities. Use for security audits,
  auth changes, secret handling, or production hardening.
---
