...
description: >
  .NET architecture specialist for reviewing and evolving solution structure,
  Clean Architecture boundaries, project references, module boundaries, and
  cross-cutting concern placement. Use when architecture, solution structure,
  dependency direction, or boundary decisions need focused analysis.
---
