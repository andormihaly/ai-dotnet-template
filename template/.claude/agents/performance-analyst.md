...
description: >
  .NET performance specialist for profiling, bottleneck analysis, caching,
  asynchronous code, allocations, query efficiency, and resource usage. Use
  when investigating measurable latency, throughput, memory, or resource
  problems, or reviewing known hot paths.
---
