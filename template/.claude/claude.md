...
The project is designed for AI-assisted software development with tools such as Claude Code and GitHub Copilot.
...
The repository provides an AI-assisted development layer built around rules, skills, specialized agents, knowledge, and MCP tools.
...
Rules define concise, always-on development constraints that must be followed across tasks.

- Follow applicable project rules at all times.
- Keep rules concise and focused on constraints that should always apply.
- Put detailed or task-specific guidance in skills rather than rules.

### Skills

Skills provide reusable technical or domain-specific knowledge and procedures.

- Skills follow the Agent Skills standard and live under `.claude/skills/<skill-name>/SKILL.md`.
- Load skills only when they are relevant to the current task.
...
Knowledge documents provide reusable project reference material that does not belong in global instructions or task-specific skills.

Use knowledge documents when additional project context or architectural rationale is needed.
...
- Do not duplicate detailed guidance that belongs in rules, skills, agents, or knowledge documents.
