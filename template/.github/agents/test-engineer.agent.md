...
name: test-engineer
description: >
  .NET testing specialist for test strategy, unit tests, integration tests, test
  infrastructure, fixtures, and meaningful coverage. Use when designing, writing,
  fixing, or reviewing tests and testability.
---
