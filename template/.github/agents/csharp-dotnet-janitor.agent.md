...
description: >
  ...
  improvements such as obsolete API replacement, dead-code cleanup, nullable fixes,
  simplification, warning cleanup, and modern C# adoption. Use when improving existing
  code without changing its intended behavior.
---
