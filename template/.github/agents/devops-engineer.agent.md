...
description: >
  DevOps specialist for .NET backend repositories covering Docker, CI/CD, deployment
  configuration, .NET Aspire, health checks, and production-oriented build and release
  concerns. Use for containerization, pipelines, deployment, or Aspire orchestration.
---
