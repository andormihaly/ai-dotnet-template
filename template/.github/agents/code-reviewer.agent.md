...
description: >
  ...
  maintainability, tests, and repository conventions. Use for PR reviews, pre-merge
  review, recent-change review, or focused code-quality analysis.
---
...
17. Do not modify source files.
18. Do not create or delete files.
19. Only inspect, analyze, and report findings.
