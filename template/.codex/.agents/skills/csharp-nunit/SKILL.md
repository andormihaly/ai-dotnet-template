...
name: csharp-nunit
description: >
  NUnit-specific testing guidance for C#/.NET. Use when the project uses
  NUnit and tests need to be created, reviewed, or maintained.
---
...
## Principles
- Follow the project's existing NUnit conventions.
...
- Do not introduce another test framework into a project that already standardizes on NUnit without a concrete reason.
